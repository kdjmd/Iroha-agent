...
try {
  ...
  $releaseNotes = @(
    ...
    "- The 2026-07-20 maintenance build removes tool-card black edges, quick-action square backfills, composer seams, and clipped action circles.",
    ...
    "- Layout QA covers 980x552 through 1920x1080; the maintenance build passed 632 automated regression assertions, including 338 settings and UI checks.",
