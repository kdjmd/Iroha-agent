...
try {
  ...
  $releaseNotes = @(
    ...
    "- The 2026-07-20 maintenance build removes tool-card black edges, quick-action square backfills, composer seams, clipped action circles, and the overlapping attachment/send glyph.",
    ...
    "- Layout QA covers 980x552 through 1920x1080; the maintenance build passed 684 automated regression assertions, including 382 settings/UI and 47 functional checks.",
