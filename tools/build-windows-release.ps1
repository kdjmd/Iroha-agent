...
try {
  ...
  $releaseNotes = @(
    ...
    "- The 2026-07-19 maintenance build removes tool-card black edges, quick-action ghost fills, and composer button collisions.",
    ...
    "- Layout QA covers 980x552 through 1920x1080; the maintenance build passed 555 automated regression assertions.",
