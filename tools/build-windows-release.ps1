...
try {
  ...
  $releaseNotes = @(
    ...
    "",
    "- Portable.zip: approximately 10 MB and does not include the large voice runtime.",
    ...
    "- Long replies open from the VN dialogue detail action in a scrollable floating window; model, tool, integrity-check, and TTS stages provide visible loading feedback.",
