...
try {
  ...
  $releaseNotes = @(
    ...
    "- The 2026-07-19 maintenance build fixes the compact high-DPI voice dock, footer spacing, and quick-action text residue.",
    "- The voice preview keeps its play control, labels, waveform, and GPT-SoVITS status visible whenever space permits.",
    "- The maintenance build passed 317 automated regression assertions.",
